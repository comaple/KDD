...
package com.easyminning.algorithm.fpm.pfpgrowth.fpgrowth2;
...
import com.easyminning.algorithm.fpm.pfpgrowth.fpgrowth2.*;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

import  com.easyminning.algorithm.fpm.pfpgrowth.fpgrowth.Pattern;
import  com.easyminning.algorithm.fpm.pfpgrowth.fpgrowth.FrequentPatternMaxHeap;
/**
...
public class FPGrowthObj<A extends Comparable<? super A>> {
 ...
 /**
   ...
   */
  private Map<Integer,FrequentPatternMaxHeap> fpGrowth(com.easyminning.algorithm.fpm.pfpgrowth.fpgrowth2.FPTree tree,
  ...
  private void generateTopKFrequentPatterns(
    ...
    com.easyminning.algorithm.fpm.pfpgrowth.fpgrowth2.FPTree tree = new com.easyminning.algorithm.fpm.pfpgrowth.fpgrowth2.FPTree(attributeFrequency, minSupport);
   ...
   */
  private static FrequentPatternMaxHeap growth(com.easyminning.algorithm.fpm.pfpgrowth.fpgrowth2.FPTree tree,
    ...
    com.easyminning.algorithm.fpm.pfpgrowth.fpgrowth2.FPTree condTree = tree.createMoreFreqConditionalTree(currentAttribute);

    Pair<com.easyminning.algorithm.fpm.pfpgrowth.fpgrowth2.FPTree, com.easyminning.algorithm.fpm.pfpgrowth.fpgrowth2.FPTree> pAndQ = condTree.splitSinglePrefix();
    com.easyminning.algorithm.fpm.pfpgrowth.fpgrowth2.FPTree p = pAndQ.getFirst();
    com.easyminning.algorithm.fpm.pfpgrowth.fpgrowth2.FPTree q = pAndQ.getSecond();
   ...
   */
  private static FrequentPatternMaxHeap mineSinglePrefix(com.easyminning.algorithm.fpm.pfpgrowth.fpgrowth2.FPTree tree, int k) {
    FrequentPatternMaxHeap pats = new FrequentPatternMaxHeap(k, true);
    com.easyminning.algorithm.fpm.pfpgrowth.fpgrowth2.FPTree.FPNode currNode = tree.root();
