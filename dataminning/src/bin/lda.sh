...
### 将序列文件转化为向量
mahout seq2sparse -i /kdd/lda/input_seq  -o /kdd/lda/vector  -ow --maxDFPercent 30 --namedVector -wt TF-IDF --analyzerName org.apache.lucene.analysis.core.WhitespaceAnalyzer
...
mahout cvb -i /kdd/lda/matrix-out/matrix -o /kdd/lda/doc   -dict /kdd/lda/vector/dictionary.file-* -dt /kdd/lda/topic -mt /kdd/lda/model --maxIter 200 --num_topics $topic
