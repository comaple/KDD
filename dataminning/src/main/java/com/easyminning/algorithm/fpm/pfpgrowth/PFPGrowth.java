...
public final class PFPGrowth {
     ...
     * @params input, output locations, additional parameters like minSupport(3), maxHeapSize(50), numGroups(1000)
     * @conf initial Hadoop configuration to use.
     */
    ...
    /**
     * @param params params should contain input and output locations as a string value, the additional parameters
    ...
    public static void startParallelFPGrowth(Parameters params, Configuration conf)
        ...
        job.setJarByClass(PFPGrowth.class);
//        int reduceNum = Integer.parseInt(params.get(NUM_GROUPS, "20"));
