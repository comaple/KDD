...
final class TransactionTreeIterator extends AbstractIterator<Pair<IntArrayList,Long>> {
  ...
  private final com.easyminning.algorithm.fpm.pfpgrowth.TransactionTree transactionTree;

  TransactionTreeIterator(com.easyminning.algorithm.fpm.pfpgrowth.TransactionTree transactionTree) {
