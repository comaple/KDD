...
import com.easyminning.algorithm.fpm.pfpgrowth.convertors.*;

/**
 * Updates the Context object of a {@link org.apache.hadoop.mapreduce.Reducer} class
 * 
 * @param <IK>
 * @param <IV>
 * @param <K>
...
public class ContextStatusUpdater<IK extends Writable,IV extends Writable,K extends Writable,V extends Writable>
    implements com.easyminning.algorithm.fpm.pfpgrowth.convertors.StatusUpdater {
