...
import com.easyminning.algorithm.fpm.pfpgrowth.CountDescendingPairComparator;
import com.easyminning.algorithm.fpm.pfpgrowth.convertors.StatusUpdater;
import com.easyminning.algorithm.fpm.pfpgrowth.convertors.TopKPatternsOutputConverter;
import com.easyminning.algorithm.fpm.pfpgrowth.convertors.TransactionIterator;
...
public class FPGrowth<A extends Comparable<? super A>> {
   ...
   */
  private Map<Integer,FrequentPatternMaxHeap> fpGrowth(com.easyminning.algorithm.fpm.pfpgrowth.fpgrowth.FPTree tree,
  ...
  private static FrequentPatternMaxHeap generateSinglePathPatterns(com.easyminning.algorithm.fpm.pfpgrowth.fpgrowth.FPTree tree,
                                                                   int k,
                                                                   long minSupport) {
    FrequentPatternMaxHeap frequentPatterns = new FrequentPatternMaxHeap(k, false);

    int tempNode = com.easyminning.algorithm.fpm.pfpgrowth.fpgrowth.FPTree.ROOTNODEID;
    com.easyminning.algorithm.fpm.pfpgrowth.fpgrowth.Pattern frequentItem = new com.easyminning.algorithm.fpm.pfpgrowth.fpgrowth.Pattern();
  ...
  private void generateTopKFrequentPatterns(
    ...
    com.easyminning.algorithm.fpm.pfpgrowth.fpgrowth.FPTree tree = new com.easyminning.algorithm.fpm.pfpgrowth.fpgrowth.FPTree(featureSetSize);
  ...
  private static FrequentPatternMaxHeap growth(com.easyminning.algorithm.fpm.pfpgrowth.fpgrowth.FPTree tree,
    ...
    while (i < headerTableCount) {
      ...
      com.easyminning.algorithm.fpm.pfpgrowth.fpgrowth.FPTree conditionalTree = treeCache.getFirstLevelTree(attribute);
  ...
  private static FrequentPatternMaxHeap growthBottomUp(com.easyminning.algorithm.fpm.pfpgrowth.fpgrowth.FPTree tree,
                                                       MutableLong minSupportMutable,
                                                       int k,
                                                       FPTreeDepthCache treeCache,
                                                       int level,
    ...
    for (int i = tree.getHeaderTableCount() - 1; i >= 0; i--) {
      ...
      com.easyminning.algorithm.fpm.pfpgrowth.fpgrowth.FPTree conditionalTree = treeCache.getTree(level);
  ...
  private static FrequentPatternMaxHeap growthTopDown(com.easyminning.algorithm.fpm.pfpgrowth.fpgrowth.FPTree tree,
                                                      MutableLong minSupportMutable,
                                                      int k,
                                                      FPTreeDepthCache treeCache,
                                                      int level,
  ...
  private static FrequentPatternMaxHeap mergeHeap(FrequentPatternMaxHeap frequentPatterns,
    ...
    if (frequentPatterns.addable(count) && addAttribute) {
      com.easyminning.algorithm.fpm.pfpgrowth.fpgrowth.Pattern p = new com.easyminning.algorithm.fpm.pfpgrowth.fpgrowth.Pattern();
  ...
  private static void traverseAndBuildConditionalFPTreeData(int firstConditionalNode,
                                                            long minSupport,
                                                            com.easyminning.algorithm.fpm.pfpgrowth.fpgrowth.FPTree conditionalTree,
                                                            com.easyminning.algorithm.fpm.pfpgrowth.fpgrowth.FPTree tree) {
    ...
    while (conditionalNode != -1) {
      ...
      if (prevConditional != -1) {
        int prevParent = conditionalTree.parent(prevConditional);
        if (prevParent == -1) {
          conditionalTree.setParent(prevConditional, com.easyminning.algorithm.fpm.pfpgrowth.fpgrowth.FPTree.ROOTNODEID);
        } else if (prevParent != com.easyminning.algorithm.fpm.pfpgrowth.fpgrowth.FPTree.ROOTNODEID) {
          throw new IllegalStateException();
        }
        if (conditionalTree.childCount(com.easyminning.algorithm.fpm.pfpgrowth.fpgrowth.FPTree.ROOTNODEID) > 1 && conditionalTree.singlePath()) {
          conditionalTree.setSinglePath(false);
        }
      }
  ...
  private static void pruneFPTree(long minSupport, com.easyminning.algorithm.fpm.pfpgrowth.fpgrowth.FPTree tree) {
    for (int i = 0; i < tree.getHeaderTableCount(); i++) {
   ...
   */
  private static int treeAddCount(com.easyminning.algorithm.fpm.pfpgrowth.fpgrowth.FPTree tree,
                                  int[] myList,
                                  long addCount,
                                  long minSupport,
                                  long[] attributeFrequency) {
