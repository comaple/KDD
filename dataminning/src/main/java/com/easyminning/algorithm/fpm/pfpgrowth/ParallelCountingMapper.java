...
public class ParallelCountingMapper extends Mapper<LongWritable,Text,Text,LongWritable> {
  ...
  protected void setup(Context context) throws IOException, InterruptedException {
    ...
    splitter = Pattern.compile(params.get(com.easyminning.algorithm.fpm.pfpgrowth.PFPGrowth.SPLIT_PATTERN, com.easyminning.algorithm.fpm.pfpgrowth.PFPGrowth.SPLITTER.toString()));
  }
}
