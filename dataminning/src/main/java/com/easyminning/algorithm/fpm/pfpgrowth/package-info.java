 ...
 * {@code com.easyminning.algorithm.fpm.pfpgrowth.convertors.string}.</p>
 *
 * {@code
 ...
 * </ul>
 *
 * <p>The command line launcher for string transaction data {@code com.easyminning.algorithm.fpm.pfpgrowth.FPGrowthJob}
