...
import com.easyminning.algorithm.fpm.pfpgrowth.convertors.SequenceFileOutputCollector;
import com.easyminning.algorithm.fpm.pfpgrowth.convertors.string.StringOutputConverter;
...
public final class FPGrowthDriver extends AbstractJob {
  ...
  public int run(String[] args) throws Exception {
    ...
    addOption("numGroups", "g", "(Optional) Number of groups the features should be divided in the map-reduce version."
              + " Doesn't work in sequential version Default Value:" + com.easyminning.algorithm.fpm.pfpgrowth.PFPGrowth.NUM_GROUPS_DEFAULT,
              Integer.toString(com.easyminning.algorithm.fpm.pfpgrowth.PFPGrowth.NUM_GROUPS_DEFAULT));
    ...
    if (hasOption("useFPG2")) {
      params.set(com.easyminning.algorithm.fpm.pfpgrowth.PFPGrowth.USE_FPG2, "true");
    }
  ...
  private static void runFPGrowth(Parameters params) throws IOException {
    ...
    String pattern = params.get("splitPattern", com.easyminning.algorithm.fpm.pfpgrowth.PFPGrowth.SPLITTER.toString());
    ...
    if ("true".equals(params.get(com.easyminning.algorithm.fpm.pfpgrowth.PFPGrowth.USE_FPG2))) {
      com.easyminning.algorithm.fpm.pfpgrowth.fpgrowth2.FPGrowthObj<String> fp
        = new com.easyminning.algorithm.fpm.pfpgrowth.fpgrowth2.FPGrowthObj<String>();
