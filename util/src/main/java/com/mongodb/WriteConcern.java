...
public class WriteConcern {
    ...
    /**
     * Calls {@link com.mongodb.WriteConcern#WriteConcern(int, int, boolean)} with wtimeout=0 and fsync=false
    ...
    /**
     * Calls {@link com.mongodb.WriteConcern#WriteConcern(int, int, boolean)} with fsync=false
     * @param w number of writes
    ...
    /**
     * Calls {@link com.mongodb.WriteConcern#WriteConcern(int, int, boolean)} with w=1 and wtimeout=0
