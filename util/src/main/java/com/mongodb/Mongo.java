...
import com.bson.io.PoolOutputBuffer;
...
public class Mongo {
     ...
     * @throws java.net.UnknownHostException if the database host cannot be resolved
     * @throws MongoException
     */
    ...
    com.bson.util.SimplePool<PoolOutputBuffer> _bufferPool =
        new com.bson.util.SimplePool<PoolOutputBuffer>( 1000 ){
