...
public class DBCursor implements Iterator<DBObject> , Iterable<DBObject> {
     ...
     * Passing a negative value will call {@link com.mongodb.DBCursor#batchSize(int)} which is the preferred method.
    ...
    public ServerAddress getServerAddress() {
        ...
        if (_it != null && _it instanceof Result)
            return ((Result)_it).getServerAddress();
