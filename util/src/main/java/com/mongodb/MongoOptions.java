...
public class MongoOptions {
    ...
    public void reset() {
        ...
        connectTimeout = 0;
        minPoolsSize = Integer.parseInt(MongoConstants.DEFAULT_MIN_POOL_SIZE);
        socketTimeout = 0;
     ...
     * Default is 10.
     *
     * @see {@linkplain com.mongodb.MongoOptions#threadsAllowedToBlockForConnectionMultiplier}</p>
     */
