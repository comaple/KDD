...
public abstract class DB {
     ...
     * This method calls {@link com.mongodb.DB#command(com.mongodb.DBObject, int) } with 0 as query option.
    ...
    /**
     * Executes a database command.
     * This method constructs a simple dbobject and calls {@link com.mongodb.DB#command(com.mongodb.DBObject) }
     * @see <a href="http://mongodb.onconfluence.com/display/DOCS/List+of+Database+Commands">List of Commands</a>
    ...
    /**
     * Executes a database command.
     * This method constructs a simple dbobject and calls {@link com.mongodb.DB#command(com.mongodb.DBObject, int)  }
     * @see <a href="http://mongodb.onconfluence.com/display/DOCS/List+of+Database+Commands">List of Commands</a>
     * @param cmd command to execute
     * @param options query options to use
     * @return result of command from the database
    ...
    /**
     * calls {@link com.mongodb.DB#doEval(String, Object[]) }.
     ...
     * You may need to explicitly use a "consistent Request", see {@link com.mongodb.DB#requestStart()}
    ...
    /**
     * @see {@link com.mongodb.DB#getLastError() }
    ...
    /**
     * @see {@link com.mongodb.DB#getLastError(com.mongodb.WriteConcern) }
     * @param w
     * @param wtimeout
     * @param fsync
     * @return The command result
    ...
    */
     ...
     * See {@link com.mongodb.DB#requestStart()} for more information.
     *
     * @return DBObject with error and status information
     * @throws MongoException
     */
     ...
     * Used to clear all errors such that {@link com.mongodb.DB#getPreviousError()} will return no error.
     * @throws MongoException
     */
